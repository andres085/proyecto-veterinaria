...
- [ ] **1.1.2** Inicializar repositorio Git
- [ ] **1.1.3** Crear .gitignore para Python y Node.js
- [ ] **1.1.4** Configurar archivo README.md principal

#### 1.2 Configuración Docker
- [ ] **1.2.1** Crear docker-compose.yml con servicios MySQL, Backend, Frontend
- [ ] **1.2.2** Configurar variables de entorno (.env)
- [ ] **1.2.3** Crear Dockerfile para backend (Python Flask)
- [ ] **1.2.4** Crear Dockerfile para frontend (Node.js/Vue)
- [ ] **1.2.5** Configurar redes y volúmenes Docker
- [ ] **1.2.6** Levantar docker-compose up para verificar servicios

### 🗄️ FASE 2: Base de Datos

#### 2.1 Configuración MySQL
- [ ] **2.1.1** Crear script de inicialización de base de datos (init_db.py)
- [ ] **2.1.2** Definir schema de tabla `duenios`
- [ ] **2.1.3** Definir schema de tabla `turnos` con foreign keys
- [ ] **2.1.5** Configurar constraints y validaciones a nivel BD
...
- [ ] **3.1.1** Crear app/__init__.py con factory pattern
...
- [ ] **4.3.8** Registrar Blueprint en app/__init__.py
...
- [ ] **5.3.10** Registrar Blueprint en app/__init__.py
